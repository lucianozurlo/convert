...
function convert_Contact_Form () {
  ...
  // Contact Form
  if (jQuery ('.convert-contact-form:not(.is-init)').length) {
    jQuery ('.convert-contact-form:not(.is-init)').each (function () {
      let $form = jQuery (this),
        $response = $form.find ('.convert-contact-form__response'),
        formData;
      ...
      $form.on ('submit', function (e) {
        ...
        jQuery
          ...
          .done (function (response) {
            ...
            $response
              .empty ()
              .removeClass ('convert-alert-danger')
              .addClass ('convert-alert-success')
              .slideDown (200);
          ...
          .fail (function (data) {
            ...
            $response
              .empty ()
              .removeClass ('convert-alert-success')
              .addClass ('convert-alert-danger')
              .slideDown (200);
